...
package parser;
    ...
    public class Grammar implements GrammarConstants {
        ...
        public static HashSet<Constant> constantSet;    /* Set of constant symbols */
        public static HashSet<Variable> variableSet;    /* Set of variable symbols */
        public static HashSet<Function> functionSet;    /* Set of function symbols */

        public static HashSet<Equation> to_select;
        public static HashSet<Equation> selected;

        public Grammar(String input, HashSet<Equation> to_select, HashSet<Equation> selected) {
                this.functionSet = new HashSet<Function>();
                this.constantSet = new HashSet<Constant>();
